...
\usepackage{lineno,hyperref,hepnames,bm,multirow,amssymb,authblk,graphicx,newclude}
\fi
\ifx\ver\verPAPER
...
\newcommand{\ellnunuTwo}{\ensuremath{\Plepton^{(2)} \,
    \APnu^{(2)}_{\kern-0.10em \Plepton} \, \Pnu^{(2)}_{\kern-0.10em
      \Pgt}}\xspace}
\newcommand{\ellMinusnunu}{\ensuremath{\Plepton^{-} \, \APnu_{\kern-0.10em \Plepton} \, \Pnu_{\kern-0.10em \Pgt}}\xspace}
\newcommand{\ellPlusnunu}{\ensuremath{\Plepton^{+} \,
    \Pnu_{\kern-0.10em \Plepton} \, \APnu_{\kern-0.10em \Pgt}}\xspace}
...
\affil[4]{Institute of Physics, University of Tartu, 50411 Tartu, Estonia}
\affil[5]{CERN, 1211 Geneva, Switzerland}
\fi
\ifx\ver\verPAPER
