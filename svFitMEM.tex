...
\newcommand{\tauhnuOne}{\ensuremath{\tauh^{(1)} \, \Pnu_{\kern-0.10em \Pgt}^{(1)}}\xspace}
\newcommand{\tauhnuTwo}{\ensuremath{\tauh^{(2)} \, \Pnu_{\kern-0.10em \Pgt}^{(2)}}\xspace}
\newcommand{\ellnunu}{\ensuremath{\Plepton \, \APnu_{\kern-0.10em \Plepton} \, \Pnu_{\kern-0.10em \Pgt}}\xspace}
\newcommand{\ellnunuOne}{\ensuremath{\Plepton^{(1)} \, \APnu_{\kern-0.10em \Plepton}^{(1)} \, \Pnu_{\kern-0.10em \Pgt}^{(1)}}\xspace}
\newcommand{\ellnunuTwo}{\ensuremath{\Plepton^{(2)} \, \APnu_{\kern-0.10em \Plepton}^{(2)} \, \Pnu_{\kern-0.10em \Pgt}^{(2)}}\xspace}
...
\newcommand{\vecMET}{\ensuremath{\bm{p}^{\textrm{\kern0.10em miss}}}\xspace}
