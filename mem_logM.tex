high mas\subsection{Artificial regularization term}
\label{sec:mem_logM}
...
The effect of adding a regularization term of the kind $\kappa \cdot \log \left( m_{\PHiggs}^{\textrm{test}(i)} / \mbox{~\GeV} \right)$ to the 
