...
\cline{2-5}
 & Mean & RMS/Mean & Mean~[\GeV] & RMS/Mean \\
\hline
$\PZ/\Pggx \to \Pgt\Pgt$ & $XXX.X$ & $0.XXX$ & $XXX.X$ & $0.XXX$ \\
$\PHiggs \to \Pgt\Pgt$: & & & & \\
 $\quad m_{\PHiggs} = 120$~\GeV & $XXX.X$ & $0.XXX$ & $XXX.X$ & $0.XXX$ \\
 ...
 $\quad m_{\PHiggs} = 700$~\GeV & $XXX.X$ & $0.XXX$ & $XXX.X$ & $0.XXX$ \\
 $\quad m_{\PHiggs} = 1000$~\GeV & $XXX.X$ & $0.XXX$ & $XXX.X$ & $0.XXX$ \\ 
 $\quad m_{\PHiggs} = 1500$~\GeV & $XXX.X$ & $0.XXX$ & $XXX.X$ & $0.XXX$ \\ 
 $\quad m_{\PHiggs} = 2500$~\GeV & $XXX.X$ & $0.XXX$ & $XXX.X$ & $0.XXX$ \\ 
\hline
\end{tabular}
